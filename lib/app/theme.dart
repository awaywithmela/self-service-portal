  ...
  static ThemeData lightTheme() {
    return ThemeData(
      ...
      textTheme: GoogleFonts.nunitoTextTheme().copyWith(
        displayLarge: GoogleFonts.nunito(fontSize: 40, fontWeight: FontWeight.w900, color: darkText),
        displayMedium: GoogleFonts.nunito(fontSize: 34, fontWeight: FontWeight.w800, color: darkText),
        headlineSmall: GoogleFonts.nunito(fontSize: 26, fontWeight: FontWeight.w800, color: primaryTeal),
        titleLarge: GoogleFonts.nunito(fontSize: 22, fontWeight: FontWeight.w700, color: darkText),
        titleMedium: GoogleFonts.nunito(fontSize: 18, fontWeight: FontWeight.w600, color: darkText),
        bodyLarge: GoogleFonts.nunito(fontSize: 17, color: darkText, height: 1.6),
        bodyMedium: GoogleFonts.nunito(fontSize: 15, color: lightText, height: 1.6),
        labelLarge: GoogleFonts.nunito(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: 0.5),
      ),
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: GoogleFonts.nunito(fontSize: 15, fontWeight: FontWeight.w600, color: lightText),
        hintStyle: GoogleFonts.nunito(fontSize: 15, color: const Color(0xFFAAC8C8)),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: GoogleFonts.nunito(fontSize: 17, fontWeight: FontWeight.w800, letterSpacing: 0.5),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: GoogleFonts.nunito(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600),
      ),
