...
class ExistingInterviewerPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ExistingInterviewerPage> createState() => _ExistingInterviewerPageState();
}

class _ExistingInterviewerPageState extends ConsumerState<ExistingInterviewerPage> {
  ...
  Future<void> _authenticate() async {
    ...
    final success = await ref
        ...
        .authenticateExistingInterviewer(_usernameController.text, _passwordController.text);
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Padding(
                      ...
                      child: IconButton(
                        icon: Icon(_obscurePassword ? Icons.visibility_off : Icons.visibility, size: 28),
                ...
                Center(
                  child: TextButton.icon(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Contact helpdesk at helpdesk@ipsos.com for password reset'),
